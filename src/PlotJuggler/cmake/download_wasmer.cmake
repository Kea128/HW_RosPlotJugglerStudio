  ...
  if(WIN32 AND NOT MINGW)
    ...
    if(WIN32)
      ...
      set_property(TARGET wasmer::wasmer APPEND PROPERTY
          INTERFACE_LINK_LIBRARIES "ws2_32;advapi32;userenv;ntdll;bcrypt")
      # Wasmer 7 guards the parser operator enum with this definition but
      # exposes a metering callback using that enum unconditionally.
      set_property(TARGET wasmer::wasmer APPEND PROPERTY
          INTERFACE_COMPILE_DEFINITIONS
          "WASM_API_EXTERN=;WASI_API_EXTERN=;WASMER_COMPILER_ENABLED")
    else()
      set_property(TARGET wasmer::wasmer APPEND PROPERTY
